...
contract BlockProperty {
    ...
    uint256 public block1 = block.basefee;
    uint256 public block2 = block.chainid;
    address public block3 = block.coinbase;
    uint256 public block4 = block.prevrandao;
    ...
    function generateRandom() public view returns (uint8) {
        ...
        uint8 number = uint8(uint256(keccak256(abi.encodePacked(block.timestamp, block.prevrandao))) % 251);
        return number;
    }
}
